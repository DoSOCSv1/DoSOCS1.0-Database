...
<h3>Installation</h3>
<ol>
  <li>Download <a href="https://github.com/socs-tools/SOCSDatabase/SQL/SPDX.sql">SPDX.sql</a> to your host server.</li>
  <li>Open a terminal and navigate to the directory you downloaded <a href="https://github.com/socs-tools/SOCSDatabase/SQL/SPDX.sql">SPDX.sql</a> to.</li>
